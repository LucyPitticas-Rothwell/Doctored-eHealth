...
2. Run the file 'main.py' (hidden due to UCL policy but can be shared on request) and the command interface instructions will take you through the programme
